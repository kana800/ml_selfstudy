...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        '''
        # mapping the upper case and the lower case letters to the vowel
        # permutations
        lettercasedict = {}
        for letter in range(0,len(VOWELS_UPPER)):
            lettercasedict[VOWELS_UPPER[letter]] = vowels_permutation[letter].upper()
        for letter in range(0,len(VOWELS_LOWER)):
            lettercasedict[VOWELS_LOWER[letter]] = vowels_permutation[letter].lower()
    ...
    def apply_transpose(self, transpose_dict):
        ...
        for letter in self.message_text:
            encryptedmessage += transpose_dict.get(letter, " ")
